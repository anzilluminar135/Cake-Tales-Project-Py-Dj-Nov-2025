...
class AddACakeView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        # data = {'categories':CategoryChoices,'flavours':FlavourChoices,'weights':WeightChoices,'shapes':ShapeChoices,'form':form}
    ...
    def post(self,request,*args,**kwargs):
        ...
        #                            category=category,flavour=flavour,shape=shape,
        #                            weight=weight,egg_added=egg_added,is_available=is_available,price=price
        #                            )
